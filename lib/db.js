...
function initializeDb(database) {
    ...
    safeAlter("ALTER TABLE transactions ADD COLUMN category_group TEXT DEFAULT ''");
    safeAlter("ALTER TABLE transactions ADD COLUMN category_sub TEXT DEFAULT ''");
    safeAlter("ALTER TABLE transactions ADD COLUMN tx_type TEXT DEFAULT 'debit'");
    safeAlter("ALTER TABLE transactions ADD COLUMN customer TEXT DEFAULT ''");
